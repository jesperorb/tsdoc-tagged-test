...
export const taggedAssertionResultFactory: TestDataFactory<
	TaggedAssertionResult
> = (overrides = {}) => ({
...
export const taggedTestResultFactory: TestDataFactory<TaggedTestResult> = (
	overrides = {}
) => {
	return {
...
export const taggedAggregatedResultFactory: TestDataFactory<
	TaggedAggregatedResult
> = (overrides = {}) => {
	return {
